...
def home():
    ...
    if request.method == 'POST':
        ...
        try:
            if calculation_type == "simple":
                ...
                chat_history.append((f"Input Expression : \n{expression}",f"Result : \n{result}",steps)) 
    ...
    return render_template('index.html', result=result,chat_history=chat_history, calculation_history=calculation_history,img_data=img_data)
